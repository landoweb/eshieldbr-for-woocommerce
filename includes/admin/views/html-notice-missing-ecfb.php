...
<div class="error">
	...
	?>
		<p><a href="<?php echo esc_url( $url ); ?>" class="button button-primary">Instalar Brazilian Market on WooCommerce</a></p>
	<?php endif; ?>
</div>
